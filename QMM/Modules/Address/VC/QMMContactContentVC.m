...
@interface QMMContactContentVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation QMMContactContentVC
...
- (void)setUpview {
    ...
    [self.mTableView registerClass:[QMMContactListCell class]
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    QMMContactListCell *cell = [tableView dequeueReusableCellWithIdentifier:HYAddressListTableViewCell_ID];
