...
#import "QMMMatchmakerVC.h"
#import "QMMMatchmakerListCell.h"
#import "YSPickerViewData.h"
#import "YSPickerView.h"

@interface QMMMatchmakerVC ()
...
@implementation QMMMatchmakerVC
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    QMMMatchmakerCellModel *sectionModel = self.viewModel.dataArray[section];
    return sectionModel.arr.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    QMMMatchmakerListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"reuseID" forIndexPath:indexPath];
    
    QMMMatchmakerCellModel *sectionModel = self.viewModel.dataArray[indexPath.section];
...
- (void)showPickerViewWithModel:(QMMMatchmakerCellModel *)model type:(FilterCellType)type {
    NSArray *dataArr = nil;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    QMMMatchmakerCellModel *sectionModel = self.viewModel.dataArray[indexPath.section];
    QMMMatchmakerCellModel *model = sectionModel.arr[indexPath.row];
...
- (void)setupSubviews {
    ...
    [self.tableView registerClass:[QMMMatchmakerListCell class] forCellReuseIdentifier:@"reuseID"];
