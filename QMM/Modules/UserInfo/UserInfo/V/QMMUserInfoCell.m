...
@implementation QMMUserInfoCell
...
- (void)setupSubviews {
    ...
    [_marryDateBtn setImage:[UIImage imageNamed:@"ic_dot_pink"] forState:UIControlStateNormal];
...
- (void)setupSubviewsLayout {
    ...
    [_nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.offset(15);
        make.top.offset(20);
        make.right.lessThanOrEqualTo(self.marryDateBtn.mas_left).offset(-15);
    }];
