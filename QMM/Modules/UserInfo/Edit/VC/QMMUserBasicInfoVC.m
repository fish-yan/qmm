...
#import "QMMUserBasicInfoVC.h"
#import "QMMUserBasicInfoVM.h"
#import "YSPickerView.h"
#import "YSPickerViewData.h"
#import "QMMUserBasicInfoCell.h"
#import "QMMUpdateUserInfoHelper.h"

@interface QMMUserBasicInfoVC ()

@property (nonatomic, strong) QMMUserBasicInfoVM *viewModel;
@property (nonatomic, strong) YSPickerView *pickerView;
@property (nonatomic, strong) QMMUpdateUserInfoHelper *updateHelper;

@end

@implementation QMMUserBasicInfoVC
...
- (void)initialize {
    ...
    self.viewModel = [QMMUserBasicInfoVM new];
    self.viewModel.type = self.type;
    self.viewModel.infoModel = self.infoModel;
    self.updateHelper = [QMMUpdateUserInfoHelper new];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    QMMUserBasicInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"reuseID" forIndexPath:indexPath];
...
- (void)showPickerViewWithModel:(QMMUserBasicInfoCellModel *)model type:(BasicInfoCellType)type {
    NSArray *dataArr = nil;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    QMMUserBasicInfoCellModel *cellModel = self.viewModel.dataArray[indexPath.row];
    BasicInfoCellType type = cellModel.type;
    
    HYUserModel *model = self.viewModel.infoModel;
    @weakify(cellModel);
...
- (void)setupSubviews {
    ...
    [self.tableView registerClass:[QMMUserBasicInfoCell class] forCellReuseIdentifier:@"reuseID"];
}
@end
