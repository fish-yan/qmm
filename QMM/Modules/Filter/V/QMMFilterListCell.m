...
@implementation QMMFilterListCell
    ...
    [[RACObserve(self, cellModel.isLocked) merge:RACObserve(self, cellModel.info)]
     subscribeNext:^(id  _Nullable x) {
         ...
         if (self.cellModel.isLocked) {
             [self.infoBtn setImage:[UIImage imageNamed:@"ic_filter_lock"] forState:UIControlStateNormal];
         } else {
...
- (void)setupSubviews {
    ...
    _arrow = [UIImageView imageViewWithImageName:@"ic_cell_arrow" inView:self.contentView];
