...
#define ZHIMA_CER_RST_NOTIF_KEY @"ZHIMA_CER_RST_NOTIF_KEY"
...
#define API_CHANGE_ORDER_STATUS @"changeorderstatusuccess"//修改订单状态
...
#define API_WITHDARW_API @"extractincome"//交易明细
...
// ----- 邀请
#define API_REFER_INFO          @"getreferinfo" // 获取用户专属推荐链接及二维码
#define API_INCOME_OVERVIEW     @"getincomeoverview" //获取用户收益接口
#define API_INCOME_LIST         @"getincomelist" //  佣金明细页面：获取用户收益的列表数据接口：
#define API_INVITE_LIST         @"getinvitelist" //邀请详情页面：
#define API_ALIPAY_WITHDRAW     @"extractincome" //支付宝提现的接口。
