...
//  YSKit
//
//  Created by Joseph Koh on 16/4/24.
...
+ (UIImage *)imageOfGradientColorWithColors:(NSArray<UIColor *> *)colors
    ...
    NSMutableArray *switchColors = [NSMutableArray arrayWithCapacity:colors.count];
    [colors enumerateObjectsUsingBlock:^(UIColor * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        id clr = (__bridge id)obj.CGColor;
        [switchColors addObject:clr];
    }];
    
    layer.colors = switchColors;
